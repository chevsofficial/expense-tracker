...
export function Benefits() {
  return (
    <section id="benefits" className="bg-base-100 py-16 md:py-24">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 md:grid-cols-2 md:items-start">
        ...
        <div className="space-y-4">
          {benefits.map((benefit) => (
            <p key={benefit} className="flex items-start gap-3 rounded-xl border border-base-300 bg-base-200 p-4">
          ...
          <div className="rounded-xl border border-primary/30 bg-primary/10 p-4 text-sm">
            ...
            <p className="mt-1 text-[var(--color-muted)]">Budgets in Spendary are informative, not restrictive. You stay in control.</p>
          </div>
        </div>
      </div>
    </section>
